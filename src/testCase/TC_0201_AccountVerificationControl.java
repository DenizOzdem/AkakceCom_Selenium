...
public class TC_0201_AccountVerificationControl extends BaseDriver {
    public static void main(String[] args) {
        ...
        Assert.assertEquals("Deniz", accountName.getText());
