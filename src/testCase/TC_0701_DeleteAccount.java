...
public class TC_0701_DeleteAccount extends BaseDriver {
    public static void main(String[] args) {
        ...
        emailLogin.sendKeys("deoztest@gmail.com");
        delay(1);

        WebElement passwordLogin = driver.findElement(By.xpath("//*[@id='lifp']"));
        passwordLogin.sendKeys("deniz.%=24");
        delay(1);
        ...
        passwordInput.sendKeys("deniz.%=24");
        delay(1);
